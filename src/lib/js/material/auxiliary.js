	   	...
	   	function getcompleteInfo(){
	   		$.ajax({
    			...
    			,contentType:"application/json"
	   			,url:layui.setter.Test_url+"/WMSManage/wms_productionattach/GetPageListJsonToken"
					  ...
					  laypage.render({
						    ...
						    ,jump: function(obj){
				    			...
				    			,contentType:"application/json"
					   			...
					   			,success:function(data,status){
					   				table.render({
									    elem: '#Mater_auxiliary'
									     ,cols: [[
//									       {field:'ID', title: '产品类型ID', sort: true, align:'center'}	
									       {field:'Quality', title: '产品名称', align:'center'}
